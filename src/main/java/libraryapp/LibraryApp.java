...
public class LibraryApp {
    ...
    public static void main(String[] args) {
        BookCatalogRepository bookCatalogRepository = new BookCatalogRepository("jdbc:postgresql://77.237.244.113:5432/LibraryAppDataBase/public/book.db");
        bookCatalogRepository.init();
        UserCardRepository userCardRepository = new UserCardRepository("jdbc:postgresql://77.237.244.113:5432/LibraryAppDataBase/public/user_card.db");
